...
function CustomPromptEditor(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { borderTop: "1px solid rgba(128,128,128,0.25)", padding: "8px 0", marginTop: 4 }, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { marginTop: 6, display: "flex", alignItems: "center", gap: 8 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", disabled: !props.ready || !props.enabled, onClick: commit, children: "\u4FDD\u5B58" }),
      saved && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { fontSize: 12, opacity: 0.8 }, children: "\u5DF2\u4FDD\u5B58\uFF08\u4E0B\u6B21\u7EC4\u88C5\u751F\u6548\uFF09" })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { fontSize: 12, opacity: 0.7, paddingTop: 4 }, children: [
      "\u4E0E\u8BB0\u5FC6/\u8EAB\u4EFD\u6BB5\u4E0D\u540C\uFF0C\u8FD9\u91CC\u7684\u5185\u5BB9\u4EE5",
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { children: "\u6307\u4EE4" }),
      "\u8EAB\u4EFD\u8FDB\u5165\u7CFB\u7EDF\u63D0\u793A\u8BCD\uFF08\u6700\u9AD8\u4FE1\u4EFB\u7EA7\uFF09\uFF0C\u7531\u4F60\u76F4\u63A5\u7F16\u5199\uFF0C\u6A21\u578B\u9700\u9075\u5B88\u3002"
    ] })
  ] });
}
...
function MemorySettingsPanel(props) {
  ...
  const [viewTab, setViewTab] = (0, import_react.useState)("all");
  ...
  const [mdExporting, setMdExporting] = (0, import_react.useState)(false);
  const [mdExportNote, setMdExportNote] = (0, import_react.useState)(null);
  const [mdExportError, setMdExportError] = (0, import_react.useState)(null);
  const [editTarget, setEditTarget] = (0, import_react.useState)(null);
  const [editDraft, setEditDraft] = (0, import_react.useState)({ content: "", topic: "", importance: 3, kind: "general" });
  const [resetConfirm, setResetConfirm] = (0, import_react.useState)(false);
  const [resetting, setResetting] = (0, import_react.useState)(false);
  const [curationNote, setCurationNote] = (0, import_react.useState)(null);
  const [curationError, setCurationError] = (0, import_react.useState)(null);
  const beginEdit = (m) => {
    setEditTarget(m.id);
  ...
  const performDelete = async (m) => {
    if (!window.confirm(`\u786E\u5B9A\u5220\u9664\u8FD9\u6761\u8BB0\u5FC6\uFF1F

\u5C42\uFF1A${m.layer === "user" ? "\u7528\u6237" : "\u8BB0\u5FC6"} \xB7 \u7C7B\u578B\uFF1A${kindLabel(m.kind)}
...
\u5220\u9664\u5C06\u88AB\u5FEB\u7167\u7559\u75D5\uFF08\u53EF\u56DE\u6EDA\u6062\u590D\uFF09${m.layer === "user" ? "\uFF1B\u7528\u6237\u5C42\u4E3A\u4E0D\u53EF\u5220\u9664\u4E8B\u5B9E\uFF0C\u5C06\u8F6C\u4E3A\u5F52\u6863" : ""}\u3002`)) return;
  ...
  const performReset = async () => {
    ...
    try {
      ...
      if (r.ok) {
        setCurationNote(
          `\u5DF2\u91CD\u7F6E\u8BB0\u5FC6\uFF1A\u6E05\u9664 ${r.memories} \u6761\u8BED\u4E49\u8BB0\u5FC6\u3001${r.episodes} \u6761\u4F1A\u8BDD\u6458\u8981\u3002\u8EAB\u4EFD\u6587\u4EF6\uFF08soul.md/user.md\uFF09\u4FDD\u7559\u3002` + (r.backedUp ? "\u91CD\u7F6E\u524D\u72B6\u6001\u5DF2\u5B58\u4E3A memory.db.pre-reset.bak \u4EE5\u4FBF\u56DE\u6EDA\u3002" : "\u26A0 \u91CD\u7F6E\u524D\u5B89\u5168\u5907\u4EFD\u5931\u8D25\uFF0C\u65E0\u6CD5\u56DE\u6EDA\uFF01")
        );
      } else {
  ...
  const downloadMarkdown = async () => {
    try {
      ...
      const note = `\u5DF2\u4E0B\u8F7D ${files.length} \u4E2A Markdown \u6863\u6848\uFF1A` + files.map((f) => `${f.label}(${f.counts?.memories ?? f.counts?.episodes ?? ""})`).join("\u3001") + `\u3002\u8BED\u4E49\u8BB0\u5FC6 ${summary.effective ?? 0} \u6709\u6548 / ${summary.archived ?? 0} \u5F52\u6863 / ${summary.lowQuality ?? 0} \u4F4E\u8D28\uFF0C\u4F1A\u8BDD ${summary.episodes ?? 0} \u6761\u3002`;
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { padding: 8, display: "flex", flexDirection: "column", gap: 4 }, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", flexWrap: "wrap", gap: 8, alignItems: "center", padding: "10px 0", borderTop: "1px solid rgba(128,128,128,0.25)", marginTop: 4 }, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", disabled: resetting, onClick: () => {
        setResetConfirm(true);
      }, style: { padding: "6px 10px", borderColor: "rgba(200,60,60,0.6)", color: "#c0392b" }, children: resetting ? "\u91CD\u7F6E\u4E2D\u2026" : "\u91CD\u7F6E\u8BB0\u5FC6" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "input",
        {
          ref: fileRef,
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { style: { fontSize: 12, opacity: 0.7 }, children: [
        ...
        "\u5168\u90E8\u73B0\u6709\u6570\u636E\uFF08\u81EA\u52A8\u5B58\u56DE\u6EDA\u5907\u4EFD\uFF09\uFF1B",
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { children: "\u91CD\u7F6E\u8BB0\u5FC6" }),
        "\u6E05\u7A7A\u5168\u90E8\u8BB0\u5FC6\u4E0E\u4F1A\u8BDD\u6458\u8981\uFF08\u4FDD\u7559 soul.md/user.md\uFF0C\u91CD\u7F6E\u524D\u81EA\u52A8\u5B58\u56DE\u6EDA\u5907\u4EFD\uFF09\u3002"
      ] })
    ] }),
    ...
    curationNote && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontSize: 12, color: "#0a7a2f" }, children: curationNote }),
    curationError && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontSize: 12, color: "#c00" }, children: curationError }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", flexWrap: "wrap", gap: 8, alignItems: "center", padding: "10px 0", borderTop: "1px solid rgba(128,128,128,0.25)", marginTop: 4 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", disabled: mdExporting, onClick: () => {
        void downloadMarkdown();
      }, style: { padding: "6px 10px" }, children: mdExporting ? "\u5BFC\u51FA\u4E2D\u2026" : "\u5BFC\u51FA Markdown" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { fontSize: 12, opacity: 0.7 }, children: "\u5206\u5C42\u5BFC\u51FA\u4E3A 3 \u4E2A Markdown \u6863\u6848\uFF1A\u8BED\u4E49\u8BB0\u5FC6\uFF0801\uFF09/ \u60C5\u666F\u6458\u8981\uFF0802\uFF09/ \u8EAB\u4EFD\uFF0803\uFF09\u3002\u542B\u5DF2\u5F52\u6863\u4E0E\u4F4E\u8D28\u91CF\uFF0C\u53EA\u8BFB\u4E0D\u4FEE\u6539\u5E93\u3002" })
    ] }),
    mdExportNote && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontSize: 12, color: "#0a7a2f" }, children: mdExportNote }),
    mdExportError && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontSize: 12, color: "#c00" }, children: mdExportError }),
    viewOpen && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(PanelModal, { title: "\u8BB0\u5FC6\u67E5\u770B", onClose: () => setViewOpen(false), children: [
      ...
      !viewLoading && view && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { display: "flex", gap: 6, marginBottom: 8 }, children: ["all", "resident"].map((t) => {
          ...
          return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "button",
            {
              ...
              children: t === "all" ? `\u5168\u90E8\uFF08${view.memoryCount}\uFF09` : `\u5E38\u9A7B\u533A T0\uFF08${view.memories.filter((m) => m.tier === 0).length}\uFF09`
            },
            t
          );
        }) }),
        ...
        view.topics.length > 0 && viewTab === "all" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { fontSize: 12, opacity: 0.8, marginBottom: 8 }, children: [
          "\u4E3B\u9898\uFF1A",
        ...
        (() => {
          ...
          if (rows.length === 0) {
            return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { opacity: 0.6, fontSize: 13 }, children: viewTab === "resident" ? "\u6682\u65E0\u5E38\u9A7B\u533A\uFF08T0\uFF09\u8BB0\u5FC6\u3002" : "\u6682\u65E0\u6709\u6548\u8BB0\u5FC6\u3002" });
          }
          return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", { style: { width: "100%", borderCollapse: "collapse", fontSize: 12 }, children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", { children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { style: { textAlign: "right", padding: "4px 6px", borderBottom: "1px solid rgba(255,255,255,0.2)" }, children: "\u64CD\u4F5C" })
            ] }) }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tbody", { children: rows.map((m) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", { children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("td", { style: { padding: "4px 6px", borderBottom: "1px solid rgba(255,255,255,0.06)", textAlign: "right", whiteSpace: "nowrap" }, children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", style: { padding: "1px 7px", fontSize: 12, marginRight: 4 }, onClick: () => beginEdit(m), children: "\u7F16\u8F91" }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", style: { padding: "1px 7px", fontSize: 12, color: "#c0392b" }, onClick: () => {
    ...
    editTarget && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PanelModal, { title: "\u7F16\u8F91\u8BB0\u5FC6", onClose: () => setEditTarget(null), children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: 10 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { style: { display: "flex", flexDirection: "column", gap: 4 }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { fontSize: 12 }, children: "\u5185\u5BB9\uFF08\u5FC5\u586B\uFF09" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "textarea",
          {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { style: { display: "flex", flexDirection: "column", gap: 4 }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { fontSize: 12 }, children: "\u4E3B\u9898" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "input",
          {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", gap: 16, flexWrap: "wrap" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { style: { display: "flex", flexDirection: "column", gap: 4 }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { fontSize: 12 }, children: "\u91CD\u8981\u5EA6" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "select",
            {
              ...
              style: { padding: "6px 8px", fontSize: 13 },
              children: [1, 2, 3, 4, 5].map((i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: i, children: i }, i))
            }
          )
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { style: { display: "flex", flexDirection: "column", gap: 4 }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { fontSize: 12 }, children: "\u7C7B\u578B" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "select",
            {
              ...
              style: { padding: "6px 8px", fontSize: 13 },
              children: ["preference", "env", "lesson", "decision", "general"].map((k) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: k, children: kindLabel(k) }, k))
            }
          )
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", gap: 8, alignItems: "center" }, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", onClick: () => setEditTarget(null), children: "\u53D6\u6D88" })
      ] })
    ] }) }),
    resetConfirm && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PanelModal, { title: "\u91CD\u7F6E\u8BB0\u5FC6", onClose: () => {
      if (!resetting) setResetConfirm(false);
    }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: 10 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontSize: 13, color: "#c0392b", fontWeight: 600 }, children: "\u6B64\u64CD\u4F5C\u4E0D\u53EF\u64A4\u9500\uFF01" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { fontSize: 13, opacity: 0.85 }, children: [
        "\u5C06",
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { children: "\u6E05\u7A7A\u5168\u90E8\u8BED\u4E49\u8BB0\u5FC6\u4E0E\u4F1A\u8BDD\u6458\u8981" }),
        "\uFF08\u542B\u5F52\u6863/\u4F4E\u8D28\u91CF\uFF09\uFF0C\u5E76\u6E05\u9664\u6574\u7406/\u9057\u5FD8/\u7EA0\u9519\u5BA1\u8BA1\u8F68\u8FF9\u3002",
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("br", {}),
        "soul.md \u4E0E user.md ",
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { children: "\u4FDD\u7559\u4E0D\u53D8" }),
        "\u3002",
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("br", {}),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("br", {}),
        "\u91CD\u7F6E\u524D\u4F1A\u81EA\u52A8\u628A\u5F53\u524D\u72B6\u6001\u4FDD\u5B58\u4E3A ",
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("code", { children: "memory.db.pre-reset.bak" }),
        "\uFF0C\u4EE5\u4FBF\u8BEF\u64CD\u4F5C\u540E\u624B\u52A8\u56DE\u6EDA\u3002"
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { fontSize: 13, opacity: 0.7 }, children: [
        "\u5373\u5C06\u6E05\u9664 ",
        view?.memoryCount ?? 0,
        " \u6761\u8BB0\u5FC6\u3001",
        view?.episodeCount ?? 0,
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", gap: 8, alignItems: "center" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", disabled: resetting, onClick: () => {
          void performReset();
        }, style: { color: "#c0392b" }, children: resetting ? "\u91CD\u7F6E\u4E2D\u2026" : "\u786E\u8BA4\u6E05\u7A7A" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", disabled: resetting, onClick: () => setResetConfirm(false), children: "\u53D6\u6D88" })
      ] })
    ] }) })
  ] });
}
...
function apply(ctx) {
  ...
  const editMemory = async (id, fields) => {
    try {
