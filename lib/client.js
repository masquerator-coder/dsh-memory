...
function MemorySettingsPanel(props) {
  ...
  const runNow = async () => {
    ...
    try {
      ...
      setTriggerResult(
        `\u6574\u7406\u5B8C\u6210\uFF1A\u51DD\u7EC3${r.refined ? "\u5DF2\u6267\u884C" : "\u5DF2\u8DF3\u8FC7\uFF08\u65E0\u5F85\u6574\u7406\u6216\u65E0 LLM \u8DEF\u7531\uFF09"}\uFF1B\u753B\u50CF\u65B0\u589E ${r.identityWrote} \u6761\uFF08\u5019\u9009 ${r.identityCandidates}\uFF09\uFF1B\u9057\u5FD8\uFF1A\u964D\u7EA7 ${r.forgetDemoted}\u3001\u5F52\u6863\u8BB0\u5FC6 ${r.forgetArchivedMem}\u3001\u5220\u9664\u8BB0\u5FC6 ${r.forgetDeletedMem}\u3001\u5F52\u6863\u4F1A\u8BDD ${r.forgetArchivedEpi}\u3001\u5220\u9664\u4F1A\u8BDD ${r.forgetDeletedEpi}`
      );
    } catch (e) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { padding: 8, display: "flex", flexDirection: "column", gap: 4 }, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { style: { display: "flex", alignItems: "center", gap: 10, padding: "8px 0" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { style: { flex: 1 }, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontSize: 12, opacity: 0.7 }, children: "\u8EAB\u4EFD\u7EF4\u62A4\u626B\u63CF\u5468\u671F\uFF08\u5728\u914D\u7F6E\u4E2D\u5F00\u542F identityAuto \u540E\u751F\u6548\uFF09" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "input",
        {
