...
export function heatOf(
  e: Pick<MemoryEntry, 'layer' | 'kind' | 'last_accessed' | 'window_freq' | 'window_start'>,
...
export function shouldDemote(e: MemoryEntry, forgetDays: ForgetDays, now = Date.now(), windowMs?: number): boolean {
...
export function shouldArchive(e: MemoryEntry, forgetDays: ForgetDays, now = Date.now(), windowMs?: number): boolean {
